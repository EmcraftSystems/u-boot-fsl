...
void ddr_cfg_phy(void) {
	...
	reg32_write(0x3c0800b4,0x1);
	reg32_write(0x3c4800b4,0x1);
	reg32_write(0x3c8800b4,0x1);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x5401a,0xf1);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54020,0xf1);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54033,0xf12d);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54039,0xf12d);
