...
#define UART_PAD_CTRL1  (PAD_CTL_PKE | PAD_CTL_PUE |		\
...
static iomux_v3_cfg_t const fec1_pads[] = {
	...
	MX6_PAD_ENET2_CRS__ENET1_MDIO | MUX_PAD_CTRL(ENET_PAD_CTRL),
...
static iomux_v3_cfg_t const phy_control_pads[] = {
	...
	/* ENET PHY Power */
	MX6_PAD_NAND_CE1_B__GPIO4_IO_2 | MUX_PAD_CTRL(NO_PAD_CTRL),
...
static int setup_fec(int fec_id)
{
	...
	/* Enable the ENET power, active high */
	gpio_direction_output(IMX_GPIO_NR(4, 2), 0);
	udelay(500);
	gpio_set_value(IMX_GPIO_NR(4, 2), 1);

	/* Reset AR8031 PHY */
	gpio_direction_output(IMX_GPIO_NR(6, 21), 0);
	udelay(500);
	gpio_set_value(IMX_GPIO_NR(6, 21), 1);
...
static iomux_v3_cfg_t const usb_otg_pads[] = {
	...
	MX6_PAD_ENET2_COL__ANATOP_OTG1_ID | MUX_PAD_CTRL(OTG_ID_PAD_CTRL),
	MX6_PAD_GPIO1_IO08__USB_OTG1_OC | MUX_PAD_CTRL(NO_PAD_CTRL),
	/* OTG2 */
	MX6_PAD_GPIO1_IO12__USB_OTG2_PWR | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_ENET2_RX_CLK__USB_OTG2_OC | MUX_PAD_CTRL(NO_PAD_CTRL),
};
...
#define USDHC4_CD_GPIO	IMX_GPIO_NR(1, 13)
...
{
	return !gpio_get_value(USDHC4_CD_GPIO);
}
