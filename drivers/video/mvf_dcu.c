...
#define DCU0_DIV4_ENABLE (0x000B0000)
	...
	dcu_writel(DCU_HSYN_PARA_BP(LCD_DCU_LEFT_MARGIN) |
			DCU_HSYN_PARA_PW(LCD_DCU_HSYNC_LEN) |
			DCU_HSYN_PARA_FP(LCD_DCU_RIGHT_MARGIN),
			DCU_HSYN_PARA);

	dcu_writel(DCU_VSYN_PARA_BP(LCD_DCU_UPPER_MARGIN) |
			DCU_VSYN_PARA_PW(LCD_DCU_VSYNC_LEN) |
			DCU_VSYN_PARA_FP(LCD_DCU_LOWER_MARGIN),
			DCU_VSYN_PARA);
	...
	dcu_writel(DCU_SYN_POL_INV_PXCK(LCD_DCU_SYN_POL_INV_PXCK) |
			DCU_SYN_POL_NEG(LCD_DCU_SYN_POL_NEG) |
			DCU_SYN_POL_INV_VS(LCD_DCU_SYN_POL_INV_VS) |
			DCU_SYN_POL_INV_HS(LCD_DCU_SYN_POL_INV_HS),
			DCU_SYN_POL);
