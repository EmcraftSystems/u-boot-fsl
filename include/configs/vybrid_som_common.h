...
#if CONFIG_SYS_CLOCK_FREQUENCY != 498000000UL && \
	CONFIG_SYS_CLOCK_FREQUENCY != 396000000UL
#error Unsupported system clock frequency!
#endif

#if defined(CONFIG_BOOT_MEDIA_QSPI) && \
	CONFIG_SYS_CLOCK_FREQUENCY == 498000000UL
#error Booting from QSPI is known to work unreliably at 498MHz
#endif
...
/* Size of malloc() pool */
#define CONFIG_SYS_MALLOC_LEN		(16 << 16)
...
#	define CONFIG_IPADDR		172.17.44.1
...
#if CONFIG_SYS_CLOCK_FREQUENCY == 498000000UL
#define CONFIG_SYS_CLKCTRL_CCSR		0x8010FF24 //PLL1 as a System clock;
#else
#define CONFIG_SYS_CLKCTRL_CCSR		0x8013FF24 //PLL1 as a System clock;
#endif
...
#else
#define CONFIG_SYS_CLKCTRL_CSCDR2	0x30114230
#endif
...
#if CONFIG_SYS_CLOCK_FREQUENCY == 498000000UL
#define CONFIG_SYS_ANADIG_SYS_CTRL	0x00002000
#define CONFIG_SYS_ANADIG_SYS_SS	0x00000000
#define CONFIG_SYS_ANADIG_SYS_NUM	0x00000006
#define CONFIG_SYS_ANADIG_SYS_DENOM	0x00000008
#define CONFIG_SYS_ANADIG_SYS_PFD_528	0x12181E13
#else
...
#define CONFIG_SYS_ANADIG_SYS_PFD_528	0x12181513
#endif
