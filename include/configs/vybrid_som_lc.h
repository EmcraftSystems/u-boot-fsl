...
/* PTB2, GPIO 24 */
#define CONFIG_LCD_RESET_GPIO_ADDR		(GPIO_BASE_ADDR)
#define CONFIG_LCD_RESET_GPIO_ADDR_SET		(GPIO_BASE_ADDR + 4)
#define CONFIG_LCD_RESET_GPIO_ADDR_CLEAR	(GPIO_BASE_ADDR + 8)
#define CONFIG_LCD_RESET_GPIO_NUM		(24)
